...
namespace rcm {
	...
	public class frmMain : System.Windows.Forms.Form {
		...
		private void InitializeComponent() {
			...
			this.panelCtrl.Controls.Add(this.labelColor);
			this.panelCtrl.Controls.Add(this.cmbColor);
			...
			this.panelCtrl.Location = new System.Drawing.Point(526, 15);
			this.panelCtrl.Name = "panelCtrl";
			this.panelCtrl.Size = new System.Drawing.Size(264, 525);
			...
			try {
				...
				if (drawOption.ShowGuideAlways || !draging.Draging) {
					if (rcdata.SelectedChip != null)
						...
						rcdata.DrawChips(!tsbSelectMode.Checked && !tsbCameraMode.Checked && panelCtrl.Visible);
					else {
...
//#else
		...
		private void pictTarget_Click(object sender, System.EventArgs e) {
			...
			RcHitStatus cursors, models;
			cursors = rcdata.Cursor.IsHit(MouseX, MouseY, pictTarget.ClientRectangle.Width, pictTarget.ClientRectangle.Height,
				!tsbSelectMode.Checked && !tsbCameraMode.Checked && panelCtrl.Visible);
			models = rcdata.model.root.IsHit(MouseX, MouseY, pictTarget.ClientRectangle.Width, pictTarget.ClientRectangle.Height);
			...
			switch (selectedButton.Text) {
				...
				case "トリム":
					...
					break;
				case "トリムフレーム":
					add(rcdata.SelectedChip = new RcChipTrimF(rcdata, rcdata.SelectedChip, cursors.HitChip.JointPosition));
					break;
				case "ホイール":
...
*/
		...
		*/
		...
		private void btnEditPanel_Click(object sender, System.EventArgs e) {
			this.SuspendLayout();
			toolStripContainer1.TopToolStripPanelVisible = /*tbMain.Visible = */ labelTip.Visible = (panelCtrl.Visible ^= true);
			btnEditPanel.Text = panelCtrl.Visible ? ">>" : "<<";
