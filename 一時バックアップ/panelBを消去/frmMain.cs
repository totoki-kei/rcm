...
namespace rcm {
	public class frmMain : System.Windows.Forms.Form {
		...
		private void InitializeComponent() {
			...
			this.tbMain.Size = new System.Drawing.Size(792, 28);
			...
			this.panelB.Location = new System.Drawing.Point(528, 43);
			this.panelB.Name = "panelB";
			this.panelB.Size = new System.Drawing.Size(264, 522);
			...
			this.panelAttr.Location = new System.Drawing.Point(0, 298);
			...
			this.cmbAttrItem0.Font = new System.Drawing.Font("ＭＳ ゴシック", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(128)));
			...
			this.labelAttrItem0.Font = new System.Drawing.Font("ＭＳ ゴシック", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(128)));
			...
			this.pictTarget.Size = new System.Drawing.Size(528, 522);
			...
			this.btnEditPanel.Location = new System.Drawing.Point(488, 48);
		...
		private void pictTarget_Paint(object sender, PaintEventArgs e) {
			if(!Initialized || Pause || device == null || this.WindowState == FormWindowState.Minimized){
				...
				//rcdata.model.root.DrawChipAll();
					...
					if(drawOption.ShowGuideAlways || !draging.Draging){
						if(rcdata.SelectedChip != null)
							rcdata.DrawChips(!tbbCursor.Pushed && !tbbCamera.Pushed);
						else{
...
//			labelTip.Text = e.KeyChar.ToString() + "(" + (int)e.KeyChar + ")";
		...
		private void miFileOpen_Click(object sender, System.EventArgs e) {
			...
			*/		
			if(!Modified || MessageBox.Show("現在のモデルを破棄します。","初期化確認",MessageBoxButtons.OKCancel,MessageBoxIcon.Question) == DialogResult.OK){
				dlgOpen.Filter = "RCM File(*.rcm)|*.rcm";
				dlgOpen.Multiselect = false;
				...
				if(dlgOpen.ShowDialog() == DialogResult.OK){
					...
					labelTip.Text = "RCMファイルを開きました : " + System.IO.Path.GetFileNameWithoutExtension(EditingFileName);
				}
				editOption.ConvertParentAttributes = buffer;
			}
		...
		private void miFileSave_Click(object sender, System.EventArgs e) {
			...
			rcdata.Save(editingFileName,GenerateOptList());
			Modified = false;
			labelTip.Text = "RCMファイルを保存しました : " + System.IO.Path.GetFileNameWithoutExtension(EditingFileName);
		}
...
//				MessageBox.Show(rcdata.chipCount.ToString());
		...
		private void miFileSaveAs_Click(object sender, System.EventArgs e) {
			dlgSave.Filter = "RCM File(*.rcm)|*.rcm";
...
/*			if(e.KeyCode == Keys.Delete)
		...
		private void miEditInfo_Click(object sender, System.EventArgs e) {
			...
			decimal fuel = 0;
			for(int i = 0;i < RcData.MaxChipCount;i++){
				RcChipBase c = rcdata.GetChipFromLib(i);
				if(c != null){
