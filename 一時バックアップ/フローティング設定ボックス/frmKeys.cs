...
namespace rcm {
	...
	public class frmKeys : System.Windows.Forms.Form {
		...
		public frmKeys(RcValList vals,RcKeyList keys) {
			//
		...
		private void InitializeComponent() {
			...
			this.lstKeyList.Items.AddRange(new object[] {
															"0(↑)",
															"1(↓)",
															"2(←)",
															"3(→)",
			...
			this.cmbVals.Location = new System.Drawing.Point(144, 104);
			this.cmbVals.Name = "cmbVals";
			this.cmbVals.Size = new System.Drawing.Size(136, 20);
			this.cmbVals.TabIndex = 2;
			this.cmbVals.SelectedIndexChanged += new System.EventHandler(this.cmbVals_SelectedIndexChanged);
			// 
			// txtStep
			// 
			this.txtStep.Location = new System.Drawing.Point(184, 152);
			this.txtStep.Name = "txtStep";
			this.txtStep.Size = new System.Drawing.Size(88, 19);
			...
			this.btnAdd.Location = new System.Drawing.Point(168, 176);
		...
		private void cmbVals_SelectedIndexChanged(object sender, System.EventArgs e) {
			if(cmbVals.SelectedIndex < 0){
				...
				labelValDefault.Text = vallist[cmbVals.SelectedIndex].Default.ToString("G9");
				labelValMin.Text = vallist[cmbVals.SelectedIndex].Min.ToString("G9");
				labelValMax.Text = vallist[cmbVals.SelectedIndex].Max.ToString("G9");
				labelValStep.Text = vallist[cmbVals.SelectedIndex].Step.ToString("G9");
				btnAdd.Enabled = true;
			}
		}
