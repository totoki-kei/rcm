...
namespace rcm {
	...
	public class frmMain : System.Windows.Forms.Form {
		...
		private System.Windows.Forms.Label labelAttrItem0;
		private System.Windows.Forms.ComboBox cmbAttrItem0;
		...
		private void InitializeComponent() {
			...
			((System.ComponentModel.ISupportInitialize)(this.pictTarget)).BeginInit();
			...
			this.labelTip.Size = new System.Drawing.Size(790, 15);
			...
			this.pictTarget.Size = new System.Drawing.Size(526, 525);
			...
			this.btnEditPanel.Location = new System.Drawing.Point(444, 99);
			...
			// panelB
			// 
			this.panelB.Controls.Add(this.btnListAdd);
			...
			this.panelB.Location = new System.Drawing.Point(526, 15);
			this.panelB.Name = "panelB";
			this.panelB.Size = new System.Drawing.Size(264, 525);
			...
			this.tabGI.Location = new System.Drawing.Point(16, 168);
			...
			// btnKey
			// 
			this.btnKey.Location = new System.Drawing.Point(184, 136);
			this.btnKey.Name = "btnKey";
			this.btnKey.Size = new System.Drawing.Size(48, 24);
			...
			// btnVal
			// 
			this.btnVal.Location = new System.Drawing.Point(184, 112);
			this.btnVal.Name = "btnVal";
			this.btnVal.Size = new System.Drawing.Size(48, 24);
			...
			this.panelAttr.Location = new System.Drawing.Point(0, 301);
			...
			this.txtName.Location = new System.Drawing.Point(168, 192);
			...
			// labelName
			// 
			this.labelName.Location = new System.Drawing.Point(168, 176);
			...
			// labelColor
			// 
			this.labelColor.Location = new System.Drawing.Point(168, 216);
			...
			this.cmbColor.Font = new System.Drawing.Font("ＭＳ ゴシック", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(128)));
			this.cmbColor.ItemHeight = 12;
			this.cmbColor.Location = new System.Drawing.Point(168, 232);
			...
			this.lstSouth.Location = new System.Drawing.Point(80, 112);
			...
			this.lstNorth.Location = new System.Drawing.Point(80, 0);
			...
			// 
			this.toolStripContainer1.ContentPanel.Controls.Add(this.btnEditPanel);
			this.toolStripContainer1.ContentPanel.Controls.Add(this.pictTarget);
			this.toolStripContainer1.ContentPanel.Controls.Add(this.panelB);
			this.toolStripContainer1.ContentPanel.Controls.Add(this.labelTip);
			this.toolStripContainer1.ContentPanel.Size = new System.Drawing.Size(790, 540);
			this.toolStripContainer1.Dock = System.Windows.Forms.DockStyle.Fill;
			this.toolStripContainer1.Location = new System.Drawing.Point(0, 0);
			this.toolStripContainer1.Name = "toolStripContainer1";
			this.toolStripContainer1.Size = new System.Drawing.Size(790, 565);
			...
			this.新規作成ToolStripMenuItem.Size = new System.Drawing.Size(171, 22);
			...
			this.開くToolStripMenuItem.Size = new System.Drawing.Size(171, 22);
			...
			this.上書き保存ToolStripMenuItem.Size = new System.Drawing.Size(171, 22);
			...
			this.名前をつけて保存ToolStripMenuItem.Size = new System.Drawing.Size(171, 22);
			...
			this.rCDTXTを開くToolStripMenuItem.Size = new System.Drawing.Size(171, 22);
			...
			this.rCDで保存ToolStripMenuItem.Size = new System.Drawing.Size(171, 22);
			...
			this.終了ToolStripMenuItem.Size = new System.Drawing.Size(171, 22);
			...
			this.設定CToolStripMenuItem.Size = new System.Drawing.Size(57, 20);
			...
			this.MinimumSize = new System.Drawing.Size(552, 592);
			this.Name = "frmMain";
			this.Text = "喪寺";
			...
			((System.ComponentModel.ISupportInitialize)(this.pictTarget)).EndInit();
		...
		private void pictTarget_Paint(object sender, PaintEventArgs e) {
			if(!Initialized || Pause || device == null || this.WindowState == FormWindowState.Minimized || NowClosing){
				...
				//rcdata.model.root.DrawChipAll();
					...
					if(drawOption.ShowGuideAlways || !draging.Draging){
						if(rcdata.SelectedChip != null)
							...
							rcdata.DrawChips(!tsbSelectMode.Checked && !tsbCameraMode.Checked && panelB.Visible);
						else{
							System.Array selectedChips = rcdata.SelectedChipList;
							for(int i = 0;i < rcdata.chipCount ;i++){
								rcdata.GetChipFromLib(i).DrawChip();
							}
							if(rcdata.SelectedChipCount > 0){
								foreach(object c in selectedChips){
									multiSelCursor.Draw(device,drawOption.CursorFrontColor,0x7000,((RcChipBase)c).FullMatrix);
								}
							}
						}
...
//			string filename = Application.StartupPath + "\\out" + (DateTime.Now.Ticks & 0xFFFF).ToString("X") + ".rcd_";
		...
		private void pictTarget_Click(object sender, System.EventArgs e) {
			...
			if(!LeastIsLeftButton || draging.Draging){
				...
				if(panelB.Visible && models.HitChip != null){
					draging.Draging = false;
					...
					case "カウル":
						if(cursors.distance < models.distance && cursors.HitChip != rcdata.Cursor){
							try{
								...
								Modified = true;
								if(treeview != null && !treeview.IsDisposed)treeview.GenerateTree();
								labelTip.Text = selected.Text + (drawOption.ShowCowl ? "を追加しました。" : "を追加しました。(現在非表示)");
							}
							catch(Exception err){
								MessageBox.Show(err.Message,"追加エラー");
								labelTip.Text = "カーソルを移動しました : " + rcdata.SelectedChip.ToString() + 
		...
		private void actionRemove(){
			...
			if(rcdata.SelectedChipCount > 0){
				if(MessageBox.Show("選択されている全てのチップを削除します。\n派生チップが存在する場合、それも削除されます。","複数選択削除確認",MessageBoxButtons.OKCancel,MessageBoxIcon.Question) == DialogResult.OK){
					object[] list = rcdata.SelectedChipList;
...
*/		}
		...
		*/
		...
		public void LoadChipInfo(){
			if(rcdata.SelectedChipCount > 0){
				panelB.Enabled = true;
				object[] chips = rcdata.SelectedChipList;
				string[] s = ((RcChipBase)chips[0]).AttrNameList;
				bool[,] enables = new bool[s.Length,2];
				RcAttrValue[] values = ((RcChipBase)chips[0]).AttrValList;
				RcAttrValue opp;
				int attrindex = 0;
				...
				for(int i = 0;i < s.Length;i++){
					foreach(object c in chips){
						...
						try{
							opp = target[s[i]];
							if(opp.Const != values[i].Const || opp.Val != values[i].Val)
								enables[i,1] = false;
						}
						catch{
							enables[i,0] = false;
...
//				btnRootChip.Enabled = true;
		...
		public void ApplyChipInfo(){
			...
			if(rcdata.SelectedChipCount > 0){
				Array array = rcdata.SelectedChipList;
				RcAttrValue attr;
				RcChipBase target;
				for(int i = 0;i < labelAttrItems.Length;i++){
...
/*			if(e.KeyCode == Keys.Delete)
		...
		private void pictTarget_Resize(object sender, System.EventArgs e) {
			...
			btnEditPanel.Top = pictTarget.Top;
		...
		private void btnEditPanel_Click(object sender, System.EventArgs e) {
			this.SuspendLayout();
			toolStripContainer1.TopToolStripPanelVisible = /*tbMain.Visible = */ labelTip.Visible = (panelB.Visible ^= true);
			btnEditPanel.Text = panelB.Visible ? ">>" : "<<";
		...
		private void tsbInsert_Click(object sender, EventArgs e) {
			...
			ProcessViewPoint(rcdata.Cursor.Matrix);
			Modified = true;
			if (treeview != null && !treeview.IsDisposed) treeview.GenerateTree(); // TODO: ツリー表示速度改善(呼び出し側)
